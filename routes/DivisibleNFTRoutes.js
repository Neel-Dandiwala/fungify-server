...
const { _mint, _transferToken, _unitsOwnedOfAToken, _divisibilityOfAToken, _totalSupplyView, _mintTemp } = require('../controller/DivisibleNFTController');
router.get('/nft/totalSupply', _totalSupplyView);
router.post('/nft/mint', _mint);
router.post('/nft/mintTemp', _mintTemp);
